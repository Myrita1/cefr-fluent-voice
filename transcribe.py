...
def convert_to_wav(file_path):
    """Convert audio files (mp3, m4a) to wav using pydub"""
    try:
...
# 4. Example usage: Provide the path to your audio file here
audio_file = "example.mp3"  # Change this to the path of your audio file
